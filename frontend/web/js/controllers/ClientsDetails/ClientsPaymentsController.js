app.controller('ClientsPaymentsController', ['$rootScope', '$scope', '$filter', '$routeParams', '$http', '$timeout',  'GlobalServices',  function ($rootScope, $scope, $filter, $routeParams, $http, $timeout, GlobalServices) {
        $scope.client = {};
        ...
        return $filter('filter')($scope.payments, $scope.searchbox);
        }

                ...
                <ul class="custom-scrollbar">
                    ...
                    <li>
                        <ul class="collapsible collapsible-accordion nav navbar-nav">
                            ...
                            <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fas fa-table"></i> 
                                ...
                                <div class="collapsible-body">
                                    <ul>
                                        ...
                                        <li><a href="#/Report/Endorsements" class="waves-effect">Endorsements</a></li>
                                        <li><a href="#/Report/Premium" class="waves-effect">Premium Report</a></li>
                                        <li><a href="#/Report/Claims" class="waves-effect">Claims Report</a></li>
                            ...
                            <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fas fa-users"></i>
                                    Ressellers<i class="fa fa-angle-down rotate-icon"></i></a>
                                <div class="collapsible-body">
                                    <ul>
                                        <li><a href="#/Reseller/View" class="waves-effect">View Postulants</a></li>

...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return static::findOne(['id' => $id, 'habilitado' => self::STATUS_ACTIVE, 'deleted' => 0, 'isReseller' => 0]);
    }
    ...
    {
        return static::findOne(['user' => $username, 'habilitado' => self::STATUS_ACTIVE, 'deleted' => 0, 'isReseller' => 0]);
    }

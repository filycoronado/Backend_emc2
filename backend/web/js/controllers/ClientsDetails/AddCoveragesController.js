...
//            }
        ...
        $scope.SaveCoverage = function () {
            $http.post('index.php?r=api/savecoverages', {old_value: $scope.old_value, modelClient: $scope.client, Gtotal: $scope.NewValueMember, vehicles: $scope.vehicles, id_client: $scope.id_client, cardInfo: $scope.cardInfo}).then(function success(response) {
                alert("Successfully");

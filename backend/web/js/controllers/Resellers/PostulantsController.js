app.controller('PostulantsController', ['$rootScope', '$scope', '$filter', '$routeParams', '$http', '$timeout',  'GlobalServices',  function ($rootScope, $scope, $filter, $routeParams, $http, $timeout, GlobalServices) {
    ...
    $http.get('index.php?r=api/get_postulans').then(function success(response) {
